...
一款用 Rust 编写的在线评测沙箱服务器，受到 https://github.com/criyle/go-judge[go-judge] 的启发，服务于 SASTOJ。
...
“rsjudge” 是 “Rust” 和 “judge” 的组合，发音为 “R-S-judge”（/ɑːr-ɛs-dʒʌdʒ/）。单词应该以小写字母书写，单词中间无空格，即使在标题或句子开头也是如此。
...
image::https://github.com/NJUPT-SAST/rsjudge/raw/diagram/diagram.svg[目录结构可视化, link=https://mango-dune-07a8b7110.1.azurestaticapps.net/?repo=NJUPT-SAST%2Frsjudge, window=_blank]
