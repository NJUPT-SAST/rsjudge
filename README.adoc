...
image::assets/rsjudge.svg[rsjudge logo, 80%, opts=inline, align=center]

[.text-center]
xref:README.zh-CN.adoc[简体中文]
...
The name “rsjudge” is a combination of “Rust” and “judge”. It is pronounced as “R-S-judge” (/ɑːr-ɛs-dʒʌdʒ/). The word should be written in lowercase, with no space in between, even in the title or at the beginning of a sentence.
...
image::https://github.com/NJUPT-SAST/rsjudge/raw/diagram/diagram.svg[Repository structure visualized, opts=inline, link=https://mango-dune-07a8b7110.1.azurestaticapps.net/?repo=NJUPT-SAST%2Frsjudge, window=_blank]
